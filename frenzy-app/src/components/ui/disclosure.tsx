  ...
  return (
    <>
      {React.Children.map(children, (child) => {
        ...
        // Type assertion with more specific type that includes className
        const childElement = child as React.ReactElement<{
          className?: string;
          [key: string]: any;
        }>;

        // Now TypeScript knows childElement.props might have className
        return React.cloneElement(childElement, {
          ...
          // Use optional chaining for className
...
export function DisclosureContent({
  ...
  // Fixed version - safely handle optional variants
